...
def buttonCreate(buttonframe,workentry,list,reports,allotwork,todayswork,workdairy,register):
    ...
    reportbutton=tkinter.Button(buttonframe,text="Reports",width=10,bg="white",border=0)
    reportbutton.grid(row=2,column=0,padx=5,pady=5)
    allotworkbutton=tkinter.Button(buttonframe,text="Allot Work",width=10,bg="white",border=0)
    allotworkbutton.grid(row=3,column=0,padx=5,pady=5)
    todaystargetbutton=tkinter.Button(buttonframe,text="Todays Target",width=10,bg="white",border=0)
    todaystargetbutton.grid(row=4,column=0,padx=5,pady=5)
    workdairybutton=tkinter.Button(buttonframe,text="Work Dairy",width=10,bg="white",border=0)
