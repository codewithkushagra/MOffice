...
def drawTable(root,table):
    def data():
         ...
         Label(frame,text="TypeC",borderwidth=1,bg="white",font="Time 14",relief=RAISED).grid(row=0,ipadx=10,ipady=10,column=5,sticky=NSEW)
         Label(frame,text="Description",borderwidth=1,bg="white",font="Time 14",relief=RAISED).grid(row=0,ipadx=10,ipady=10,column=6,sticky=NSEW)
         Label(frame,text="Assessment Year",borderwidth=1,bg="white",font="Time 14",relief=RAISED).grid(row=0,ipadx=10,ipady=10,column=7,sticky=NSEW)
         Label(frame,text="Recieve Date",borderwidth=1,bg="white",font="Time 14",relief=RAISED).grid(row=0,ipadx=10,ipady=10,column=8,sticky=NSEW)
         Label(frame,text="Work Status",borderwidth=1,bg="white",font="Time 14",relief=RAISED).grid(row=0,ipadx=10,ipady=10,column=9,sticky=NSEW)
         Label(frame,text="Alloted To",borderwidth=1,bg="white",font="Time 14",relief=RAISED).grid(row=0,ipadx=10,ipady=10,column=10,sticky=NSEW)
         ...
         for i in table:
            ...
            Label(frame,text=i[7],borderwidth=1,font="Time 12").grid(row=row,padx=10,ipady=10,column=8,sticky=W)
            Label(frame,text=i[8],borderwidth=1,font="Time 12").grid(row=row,padx=10,ipady=10,column=9,sticky=W)
            Label(frame,text=i[9],borderwidth=1,font="Time 12").grid(row=row,padx=10,ipady=10,column=10,sticky=W)
            row+=1
